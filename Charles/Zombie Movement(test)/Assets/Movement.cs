...
public class Movement : MonoBehaviour
{
    ...
    void Start()
    {
        InvokeRepeating("CallFootsteps", 0, avarageSpeed);
    }
    ...
    void Update()
    {
        ...
        avarageSpeed = ((myRigidbody2D.velocity.x + myRigidbody2D.velocity.y) / 2.0f) * speed * Time.deltaTime;

        Debug.Log(avarageSpeed);
    }
